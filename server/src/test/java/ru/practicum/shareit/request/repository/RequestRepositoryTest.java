...
class RequestRepositoryTest {
    ...
    void getByIdAndCheck_IsRequestValid() {
        assertEquals(createdRequest1, requestRepository.findByRequestId(createdRequest1.getId()));
    }

    @Test
    void getByIdAndCheck_IsItemInvalid() {
        assertThrows(NotFoundException.class, () -> requestRepository.findByRequestId(999L));
    }

    @Test
    void getAllByRequestorId() {
        assertEquals(List.of(createdRequest1, createdRequest2), requestRepository.findAllByRequestorId(createdUser1.getId()));
    }
